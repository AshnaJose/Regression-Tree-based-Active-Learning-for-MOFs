The jupyter notebook **RT-AL_MOFs_example.ipynb** contains a comprehensive example of using Regression Tree-based active learning (RT-AL) on the QMOF dataset. 
